...
public class RestrictionListener implements Listener {
    ...
    public void onBlockPlace(BlockPlaceEvent event) {
        ...
        if (!AntiRelog.getInstance().getCancelSetting("block-place")) {
            return;
        }
    ...
    public void onBlockBreak(BlockBreakEvent event) {
        ...
        if (!AntiRelog.getInstance().getCancelSetting("block-break")) {
            return;
        }
        event.setCancelled(true);
        player.sendMessage(StringUtility.getMessage(
    ...
    public void onPotionThrow(ProjectileLaunchEvent event) {
        ...
        if (!AntiRelog.getInstance().getCancelSetting("potion-throw")) {
            return;
        }
        event.setCancelled(true);
        player.sendMessage(StringUtility.getMessage(
